...
export default function EventDetails() {
  ...
  return (
    <div className="flex min-h-svh flex-col bg-[#0d0c0c] pb-[176px]">
      ...
      <div className="relative px-[var(--gutter)] pb-6 pt-4">
        <div
        ...
        <div className="relative flex flex-col gap-6">
          ...
          <div className="flex w-full flex-col gap-2">
            ...
            <div className="flex flex-col gap-0 pt-2 text-[16px] leading-6 text-[#c7caca]">
      ...
      {/* Content card */}
      <div className="flex w-full flex-col gap-8 px-[var(--gutter)] py-4">
